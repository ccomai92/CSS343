...
template<class Key, class Value>
Treap<Key, Value>::Iterator::Iterator(): current(nullptr), pair(nullptr) {}

template<class Key, class Value>
Treap<Key, Value>::Iterator::Iterator(Node* node): pair(nullptr) {
    this->leftMost(node);
}
...
typename Treap<Key, Value>::Iterator Treap<Key, Value>::begin() {
    return Treap<Key, Value>::Iterator(this->root);
}

template<class Key, class Value>
typename Treap<Key, Value>::Iterator Treap<Key, Value>::end() {
    return Treap<Key, Value>::Iterator();
}
